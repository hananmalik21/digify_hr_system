...
import 'package:digify_hr_system/features/time_management/presentation/widgets/schedule_assignments/components/assignment_level_capsule.dart';
        ...
        children: [
          ...
          if (ScheduleAssignmentsTableConfig.showAssignmentLevel)
            _buildDataCell(
              ...
              ScheduleAssignmentsTableConfig.assignmentLevelWidth.w,
            ),
