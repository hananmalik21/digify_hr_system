        ...
        children: [
          ...
          Expanded(
            child: TabBarView(
              ...
              children: [
                AccountInformationTab(isDark: isDark),
                RolesAndResponsibilitiesTab(isDark: isDark),
                AccessAndPermissionsTab(isDark: isDark),
                UserPreferencesTab(isDark: isDark),
                SecuritySettingsTab(isDark: isDark),
              ],
            ),
          ),
