...
class DepartmentValuesView extends ConsumerStatefulWidget {
  const DepartmentValuesView({super.key});

  @override
  ConsumerState<DepartmentValuesView> createState() => _DepartmentValuesViewState();
}

class _DepartmentValuesViewState extends ConsumerState<DepartmentValuesView> {
  static const OrganizationLevel _level = OrganizationLevel.department;
