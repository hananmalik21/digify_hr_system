...
class SectionValuesView extends ConsumerStatefulWidget {
  const SectionValuesView({super.key});

  @override
  ConsumerState<SectionValuesView> createState() => _SectionValuesViewState();
}

class _SectionValuesViewState extends ConsumerState<SectionValuesView> {
  static const OrganizationLevel _level = OrganizationLevel.section;
