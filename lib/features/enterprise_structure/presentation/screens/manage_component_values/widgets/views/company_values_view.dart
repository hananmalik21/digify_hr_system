...
class CompanyValuesView extends ConsumerStatefulWidget {
  const CompanyValuesView({super.key});

  @override
  ConsumerState<CompanyValuesView> createState() => _CompanyValuesViewState();
}

class _CompanyValuesViewState extends ConsumerState<CompanyValuesView> {
  static const OrganizationLevel _level = OrganizationLevel.company;
