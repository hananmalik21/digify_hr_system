...
class MarkAttendanceFormNotifier
    extends StateNotifier<MarkAttendanceFormState> {
  ...
  void initializeFromAttendance(Attendance attendance) {
    state = MarkAttendanceFormState(
      ...
      checkOutTime: attendance.clockOut != null
          ...
          : null,
      overtimeHours:
          attendance.workedHours != null && attendance.workedHours! > 8
          ? (attendance.workedHours! - 8).toInt()
          : 0,
      location:
          attendance.checkInLocation?.city ??
...
final markAttendanceFormProvider =
    StateNotifierProvider<MarkAttendanceFormNotifier, MarkAttendanceFormState>((
      ref,
    ) {
