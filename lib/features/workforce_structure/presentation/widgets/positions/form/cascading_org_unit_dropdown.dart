  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    final isEnabled =
        ...
        (levelIndex > 0 &&
            selectionState.getSelection(
                  activeLevels[levelIndex - 1].levelCode,
                ) !=
                null);
    ...
    return PositionLabeledField(
      ...
      child: InkWell(
        onTap: isEnabled
            ? () async {
                // Only trigger loading if we have no options and not already loading
                ...
                // Show dialog (it will watch the provider and update reactively)
                ...
                // If user selected something, notify parent
                if (selected) {
