...
class GradeFormDialog extends StatefulWidget {
  ...
  static Future<void> show(
    ...
    return showDialog<void>(
      context: context,
      builder: (_) =>
          GradeFormDialog(grade: grade, onSave: onSave, isEdit: isEdit),
    );
  }
...
class _GradeFormDialogState extends State<GradeFormDialog> {
  ...
  void initState() {
    ...
    gradeNumberController = TextEditingController(
      text: grade?.gradeLabel ?? '',
    );
    gradeCategoryController = TextEditingController(
      text: grade?.gradeCategory ?? '',
    );
